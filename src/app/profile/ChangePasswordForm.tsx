...
import { IconAlert, IconEye, IconEyeOff, IconKey } from '@/components/ui/Icons';
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        toast.error('No se pudo cambiar la contraseña', json?.error);
        return;
      }
      toast.success(
        'Contraseña actualizada',
        forceChange ? 'Redirigiendo al panel...' : 'Tus credenciales se actualizaron correctamente.'
      );
      setCurrentPassword('');
      setNewPassword('');
      setConfirmPassword('');
